  ...
  (fragL ((items T)) ((lst))
	 ...
	 ()
         ...
         ((when items
            ...
            (setq list-end items)
            (if (null lst) (setq lst items)))) () () nil)
 :trigger T)
